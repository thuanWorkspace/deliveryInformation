...
}`)}function l(e,t){const{vertex:l}=e;switch(t.output){case a.ShaderOutput.Color:if(t.receiveShadows)return o(e),void l.code.add(d.glsl`void forwardLinearDepth() { linearDepth = gl_Position.w; }`);break;case a.ShaderOutput.Depth:case a.ShaderOutput.Shadow:case a.ShaderOutput.ShadowHighlight:case a.ShaderOutput.ShadowExcludeHighlight:return e.include(r.VertexPosition,t),o(e),i(e),n(e),void l.code.add(d.glsl`void forwardLinearDepth() {
linearDepth = calculateLinearDepth(nearFar, vPosition_view.z);
}`)}l.code.add(d.glsl`void forwardLinearDepth() {}`)}e.ForwardLinearDepth=l,e.addCalculateLinearDepth=n,e.addLinearDepth=o,e.addNearFar=i,Object.defineProperty(e,Symbol.toStringTag,{value:"Module"})}));
