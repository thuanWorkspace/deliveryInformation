...
return ambientLight * (1.0 - ambientOcclusion);
}`),t.pbrMode!==h.PBRMode.Normal&&t.pbrMode!==h.PBRMode.Schematic||e.code.add(a.glsl`const vec3 skyTransmittance = vec3(0.9, 0.9, 1.0);
vec3 calculateAmbientRadiance(float ambientOcclusion)
{
vec3 ambientLight = 1.2 * (0.282095 * lightingAmbientSH0) - 0.2;
return ambientLight *= (1.0 - ambientOcclusion) * skyTransmittance;
}`))}const r=t.create(),m=e.create();i.EvaluateAmbientLighting=o,Object.defineProperty(i,Symbol.toStringTag,{value:"Module"})}));
