...
define(["exports","../views/3d/webgl-engine/core/shaderLibrary/shading/MultipassTerrainTest.glsl","../views/3d/webgl-engine/core/shaderLibrary/util/ColorConversion.glsl","../views/3d/webgl-engine/core/shaderLibrary/util/View.glsl","../views/3d/webgl-engine/core/shaderModules/Float2PassUniform","../views/3d/webgl-engine/core/shaderModules/Float4PassUniform","../views/3d/webgl-engine/core/shaderModules/interfaces","../views/3d/webgl-engine/core/shaderModules/ShaderBuilder","../views/3d/webgl-engine/lib/TransparencyPassType","../views/3d/webgl-engine/lib/VertexAttribute"],(function(e,i,r,a,o,s,l,d,t,n){"use strict";function c(e){const c=new d.ShaderBuilder,{vertex:u,fragment:v}=c;return a.addProjViewLocalOrigin(u,e),c.attributes.add(n.VertexAttribute.POSITION,"vec3"),c.attributes.add(n.VertexAttribute.UV0,"vec2"),c.varyings.add("vUV","vec2"),e.multipassEnabled&&c.varyings.add("depth","float"),u.code.add(l.glsl`
  ...
  `),c.include(i.multipassTerrainTest,e),v.uniforms.add(new o.Float2PassUniform("size",(e=>e.size))),v.uniforms.add(new s.Float4PassUniform("color1",(e=>e.color1))),v.uniforms.add(new s.Float4PassUniform("color2",(e=>e.color2))),v.include(r.ColorConversion),v.code.add(l.glsl`
    void main() {
      ...
      ${e.transparencyPassType===t.TransparencyPassType.Color?"fragColor = premultiplyAlpha(fragColor);":""}
    }
