...
*/
define(["exports","../views/3d/webgl-engine/core/shaderLibrary/ScreenSpacePass.glsl","../views/3d/webgl-engine/core/shaderModules/interfaces","../views/3d/webgl-engine/core/shaderModules/ShaderBuilder","../views/3d/webgl-engine/core/shaderModules/Texture2DPassUniform"],(function(e,o,r,t,s){"use strict";const c={maxSearchSteps:8,maxDistanceAreaTex:16};function x(){const e=new t.ShaderBuilder;return e.include(o.ScreenSpacePass),e.fragment.uniforms.add(new s.Texture2DPassUniform("edgesTexture",(e=>e.inputTexture))),e.fragment.uniforms.add(new s.Texture2DPassUniform("areaTexture",(e=>e.areaTexture))),e.fragment.uniforms.add(new s.Texture2DPassUniform("searchTexture",(e=>e.searchTexture))),e.fragment.code.add(r.glsl`
      ...
      float searchXLeft( sampler2D edgesTex, sampler2D searchTex, vec2 texcoord, float end, vec2 resolution ) {
        vec2 e = vec2( 0.0, 1.0 );
        for ( int i = 0; i < ${r.glsl.int(c.maxSearchSteps)}; i ++ ) {
      ...
      vec2 getArea( sampler2D areaTex, vec2 dist, float e1, float e2, float offset ) {
        vec2 texcoord = float( ${r.glsl.int(c.maxDistanceAreaTex)} ) * round( 4.0 * vec2( e1, e2 ) ) + dist;
      ...
      void main() {
        ...
        vec4 maxOffset = vec4( offsets[0].xz, offsets[1].yw ) + vec4( -2.0, 2.0, -2.0, 2.0 ) * resolution.xxyy * float( ${r.glsl.int(c.maxSearchSteps)} );
    ...
    `),e}const d=Object.freeze(Object.defineProperty({__proto__:null,build:x},Symbol.toStringTag,{value:"Module"}));e.BlendWeights=d,e.build=x}));
